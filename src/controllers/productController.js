...
var createProduct = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, productId, name_1, price, rating, stockQuantity, product, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = req.body, productId = _a.productId, name_1 = _a.name, price = _a.price, rating = _a.rating, stockQuantity = _a.stockQuantity;
